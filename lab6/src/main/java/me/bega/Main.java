...
public class Main {
    ...
    int averows;
    int extra;
    static int[] offset = new int[1];
    static int[] rows = new int[1];
    int mtype;
    ...
    static void matrixMultiplication(int Size) {
        int i, j, k;
        for (i=0; i < Size; i++) {
            for (j=0; j < Size; j++) {
                c[i*Size+j] = 0;
    ...
    static double calculateCannon(String[] args, int size){
        int p, p_sqrt, id;
        int[] coord = new int[2];
        int[] dim = new int[2];
    ...
    static double calculateTape(int matrixSize, String[] args){
        int dim = matrixSize;
        int i, j, k, p, ind;
        double temp;
        Status status;
    ...
    static double calculateOrd(int matrixSize, String[] argv){
        MPI.Init(argv);
    ...
    public static void main(String[] args) throws MPIException {
        ...
        if (toPrint == 12){
            System.out.println(" -------------------------------------------------------------------------------------------------------------");
            System.out.println("|             | Поcлідовний алгоритм |                     Паралельний алгоритм (2 потоки)                    |");
