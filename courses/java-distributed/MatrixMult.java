...
//    	//A more efficient approach would be only send the relevant rows/columns to reach rank
//    	mpi.MPI_Bcast(a.getValues(), 0, a.getNRows() * a.getNCols(), 0, mpi.MPI_COMM_WORLD);
//    	mpi.MPI_Bcast(a.getValues(), 0, b.getNRows() * b.getNCols(), 0, mpi.MPI_COMM_WORLD);
//    	
...
//    	else
//    	{
//    		mpi.MPI_Isend( c.getValues(), startRow * c.getNCols(),  (endRow - startRow) * c.getNCols(), 0, myRank, mpi.MPI_COMM_WORLD);
//    	}
    }//end of method
}